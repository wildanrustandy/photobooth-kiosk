...
<template>
  <div class="h-screen bg-background font-body text-on-surface flex flex-col selection:bg-primary/20 bg-confetti">
    <header class="flex-none flex justify-between items-center px-8 py-4 bg-white/50 backdrop-blur-sm border-b border-surface-container">
      <div class="flex items-center gap-4">
        <span class="text-2xl font-black text-primary tracking-tighter font-headline">Photobooth</span>
      </div>
      <nav>
        <span class="text-primary font-extrabold font-headline text-lg tracking-tight">Step 5/5</span>
      </nav>
